  ...
  const Roadmap = ({ title, description, href }: StepProps) => (
    ...
    >
      <div className="flex flex-row justify-between">
        <p
          className={`text-base md:text-base lg:text-lg lg:font-bold text-gray-200 pb-4 pl-4 font-bold`}
        >
          {title}
        </p>
      </div>
      <p
        className={`leading-loose text-gray-200 text-start text-sm md:text-base px-4 pb-4`}
      >
        {description}
      </p>
    </a>
    ...
    <>
      <div className="pb-24 lg:pt-8 lg:pb-40 px-4 md:px-12 mx-auto max-w-screen-xl text-center lg:px-6">
        <div className="mx-auto max-w-screen-sm mt-12">
          <p className="py-12 lg:py-0 text-gray-200 lg:mb-8 text-2xl md:text-4xl font-bold dark:text-gray-200">
            Roadmaps
          </p>
